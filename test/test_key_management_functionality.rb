...
class TestKeyManagementFunctionality < Test::Unit::TestCase
  ...
  def test_installed_public_keys
    setup_for_key_tests
    before = Gpgr::Keys.installed_public_keys.size
    Gpgr::Keys.import @john_key
    Gpgr::Keys.import @mark_key
    assert_equal before + 2, Gpgr::Keys.installed_public_keys.size
  ...
  def test_import_all_keys_at_a_path
    ...
    assert_equal before + 3, Gpgr::Keys.installed_public_keys.size
    cleanup_batch_keys
  end
